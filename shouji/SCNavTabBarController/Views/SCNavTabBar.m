...
- (void)viewConfig
{
    ...
    [self viewShowShadow:self shadowRadius:10.0f shadowOpacity:5.0f];
}

- (void)showLineWithButtonWidth:(CGFloat)width
{
    _line = [[UIView alloc] initWithFrame:CGRectMake(2.0f, NAV_TAB_BAR_HEIGHT - 3.0f, width - 4.0f, 3.0f)];
    _line.backgroundColor = UIColorWithRGBA(0.f, 184.f, 156.f, 0.7f);
...
- (void)setCurrentItemIndex:(NSInteger)currentItemIndex
{
    ...
    [button setTitleColor:UIColorWithRGBA(0.f, 184.f, 156.f, 0.7f) forState:UIControlStateNormal];
